...
% Use if want to extract all the type of feature 1 trhough 3
%if nargin < 3
%    select = [1:5];
%    mask = [];
%end

% Use this if you want to extract all the type of feautres 1 trought 5
%select = [1:5];
...
[graphfeats] = get_graph_features([gb_r]',[gb_c]',img);
